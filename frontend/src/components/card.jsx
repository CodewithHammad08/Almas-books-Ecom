      ...
      <div className='p-3 sm:p-5 flex flex-col flex-1'>
        ...
        <div className="mt-auto pt-2">
          ...
          <button
            ...
            className='flex w-full items-center justify-center gap-1.5 sm:gap-2 bg-amber-400 hover:bg-amber-500 text-black font-bold py-2 sm:py-2.5 rounded-xl transition-colors duration-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-neutral-700 disabled:text-neutral-400 text-xs sm:text-sm'
          >

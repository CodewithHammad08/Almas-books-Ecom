...
const PrintInfo = () => {
  return (
    <div className="bg-black w-full py-24 border-t border-neutral-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <Link to="/print-services" className="group inline-flex items-center gap-3 bg-amber-400 px-8 py-4 text-black rounded-full font-bold text-xl hover:bg-amber-500 transition-all duration-300 hover:shadow-[0_0_20px_rgba(251,191,36,0.4)]">
              Start Printing
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            ...
            {/* B&W Card */}
            <div className="bg-neutral-900 rounded-3xl p-8 border border-neutral-800 hover:border-amber-500/50 transition-all duration-300 hover:-translate-y-2 group cursor-default shadow-lg shadow-black/50">
              <div className="bg-neutral-800 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-white transition-colors duration-300">
            ...
            {/* Color Card */}
            <div className="bg-neutral-900 rounded-3xl p-8 border border-neutral-800 hover:border-amber-500/50 transition-all duration-300 hover:-translate-y-2 group cursor-default shadow-lg shadow-black/50">
              <div className="bg-neutral-800 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-amber-500 transition-colors duration-300">

...
const Hero = () => {
  return (
    <div className="relative w-full min-h-[85vh] bg-black overflow-hidden flex flex-col justify-center">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-12 sm:pt-40 lg:pt-48">
        <div className="max-w-2xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-neutral-300 mb-10 leading-relaxed max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/shop" className="group bg-amber-400 px-8 py-4 flex items-center justify-center gap-3 text-black rounded-full font-bold text-lg hover:bg-amber-500 transition-all duration-300 hover:shadow-[0_0_20px_rgba(251,191,36,0.4)]">
                Shop Now
                <ArrowRight className="group-hover:translate-x-1 transition-transform" size={20} strokeWidth={2.5}/>
              </Link>
              
              <Link to="/print-services" className="group px-8 py-4 flex items-center justify-center gap-3 text-white rounded-full font-bold text-lg border border-neutral-700 hover:border-amber-500/50 hover:bg-neutral-900/50 backdrop-blur-sm transition-all duration-300">
                Print Services
